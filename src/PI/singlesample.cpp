...
void SingleSample::initialize(){x = new double[L*sizeof(double)];}

// Getters
double SingleSample::get_sample(int pos){return x[pos];} // Return sample at integer position only
int SingleSample::getFS(){return info.samplerate;}
double SingleSample::get_rate(){return rate;}
int SingleSample::get_L(){return L;}
double* SingleSample::get_x(){return x;}
//double SingleSample::get_pos(){}

// Setters
void SingleSample::set_rate(double r){rate = r;}
void SingleSample::set_f(int in){f =  in;}
void SingleSample::set_sr(int in){sr =  in;}
void SingleSample::set_L(int in){L =  in;}
void SingleSample::set_nChannels(int in){ nChannels =  in;}
